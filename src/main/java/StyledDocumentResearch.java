...
//</editor-fold>
    ...
    void showStyles() {
        ...
        while (e1.hasMoreElements()) {
            ...
            while (e.hasMoreElements()) {
                ...
                } else if (o instanceof String attrName) {
    ...
    private void iconifyButton(JButton theButton, String iconPath) {
        ...
        if (buttonIconImage != null) {
            Image tmpImg = buttonIconImage.getImage();
            tmpImg = tmpImg.getScaledInstance(16, 16, Image.SCALE_SMOOTH);
            buttonIconImage.setImage(tmpImg);
